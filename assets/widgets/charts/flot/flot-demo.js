...
$(function() {
    ...
    var previousPoint = null;
    $("#data-example-2").bind("plothover", function (event, pos, item) {
        $("#x").text(pos.x.toFixed(2));
        $("#y").text(pos.y.toFixed(2));
    });

    $("#data-example-2").bind("plotclick", function (event, pos, item) {
        if (item) {
