...
<body id="Salamander">
                                                ...
                                                <form class="form-horizontal">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-1 text-right">
                                                            <a href="crear_cliente.php" class="btn btn-default">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="editar_cliente.php" class="btn btn-default">
                                                            <i class="glyph-icon icon-pencil"></i>
                                                        </a>
                                                        <a href="#!" class="btn btn-default" data-toggle="modal" data-target="#deleteCliente">
    ...
    <div class="modal fade" id="deleteCliente" tabindex="-1" role="modal" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body text-center">
                    <h3 class=" font-bold mrg15B">¿Estas seguro que deseas borrar un cliente?</h3>
                    <div class="form-group">
                        <div class="col-sm-12 mrg15B">
                            <a class="btn btn-primary bg_blue btn-modal font-white" data-toggle="modal" data-dismiss="modal">Borrar</a>
                        </div>
                        <div class="col-sm-12">
                            <button type="button" class="btn btn-default btn-modal bg_gris font-white" data-dismiss="modal">Continuar</button>
                        </div>
                    </div>
                </div>
            </div>
